...
export const startHere = {
  title: 'Start here',
  body: 'Pick one general assistant, ChatGPT or Claude, and commit to it. Add one meeting notetaker, Granola or Fathom. That pair is the highest-return move on this list.',
}
